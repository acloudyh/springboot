...
import com.yang.springboot.common.exceptions.error.ErrorEnum;
import com.yang.springboot.common.exceptions.error.ErrorVM;
import com.yang.springboot.common.exceptions.error.FieldVM;
...
public abstract class AbstractExceptionTranslator {
    ...
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    @ResponseBody
    protected ErrorVM processServiceError(DemoException ex) {
